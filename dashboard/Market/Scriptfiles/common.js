...
if (prefersDarkMode.matches) {
	...
	$("body").addClass("dark");
	$("#mutualfund").contents().find("body").removeClass("darks");
	$("#mutualform").contents().find("body").removeClass("darks");
} else {
	...
	$("#mutualfund").contents().find("body").addClass("darks");
	$("#mutualform").contents().find("body").addClass("darks");
}
...
const downloadPdf = () => {
	...
	let upperCaseName = name.substring(0, 4).toUpperCase();
